...
async def member_has_left(client: app, member: ChatMemberUpdated):
    ...
    if user.photo and user.photo.big_file_id:
        try:
            ...
            caption = f"**#New_Member_Left**\n\n**๏** {user.mention} **𝘾𝙃𝘼𝙇𝙀 𝙂𝘼𝙔𝙀 𝘼𝙋 𝙔𝘼𝘼𝘿 𝘼𝙔𝙀𝙂𝙄 𝘼𝙋𝙆𝙄 𝙋𝙀𝙍 𝙒𝘼𝙋𝙄𝙎 𝙅𝘼𝙍𝙊𝙊𝙍 𝘼𝙉𝘼 𝙄𝙎𝙄 𝙂𝙍𝙊𝙐𝙋 𝙈𝘼𝙔🥺**/ \n**๏ 𝘼𝙍𝙀𝙀 𝘿𝙀𝙆𝙃𝙊 𝙆𝙔𝘼 𝙃𝙊𝙂𝙔𝘼 𝙀𝙆 𝙈𝙀𝙈𝙀𝘽𝙀𝙍 𝘾𝙃𝘼𝙇𝘼 𝙂𝙔𝘼 𝙃 𝙆𝙊𝙄 𝙄𝙎 𝙆𝙊 𝙑𝙄𝙋𝙄𝙎𝙎 𝘽𝙐𝙇𝘼 𝘿𝙊 𝙋𝙇𝙀𝘼𝙎𝙀 𝙈𝘼𝙔 𝘽𝘼𝘼𝙏 𝙆𝘼𝙍𝙐𝙉𝙂𝙄 𝙐𝙎𝙎𝙀..!**"
