...
from FIXXMUSIC.mongo.readable_time import get_readable_time
from FIXXMUSIC.mongo.afkdb import add_afk, is_afk, remove_afk


@app.on_message(filters.command(["vafk", "brb"], prefixes=["/", "!"]))
