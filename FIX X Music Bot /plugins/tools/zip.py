...
@app.on_message(filters.command("vzip"))
...
@app.on_message(filters.command("vunzip"))
def unzip_command(client, message):
    if message.reply_to_message and message.reply_to_message.document and message.reply_to_message.document.file_name.endswith(
            ".zip"):
