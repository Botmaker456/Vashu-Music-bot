...
import asyncio
import time
from FIXMUSIC import app
from FIXMUSIC.misc import SUDOERS
from pyrogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton

GALI = [
    "AAND BAANG SAYTANI KHOPDA TERE MAA LE VASHU KA 12 INCH LAND TERE MA KA BOSDA🤣🤣",
    "TERE BHEN KI ROOJ CHUT MARU MAY BHEN KE LODE MAA CHUDA JAKE",
    "𝗧𝗘𝗥𝗜 bhen 𝗡𝗛𝗜 𝗛𝗔𝗜 𝗞𝗬𝗔? 9 𝗠𝗔𝗛𝗜𝗡𝗘 𝗥𝗨𝗞 𝗦𝗔𝗚𝗜 bhen 𝗗𝗘𝗧𝗔 𝗛𝗨 🤣🤣🤩",
    " TERI BHEN KI CHUT MARU PAPITA KHILATE KHILATE MADARCHOD✈️🛫",
    "𝗧𝗘𝗥𝗜 𝗠𝗔́𝗔̀ 𝗞𝗜 𝗖𝗛𝗨𝗨́𝗧 𝗠𝗘 𝗦𝗨𝗧𝗟𝗜 𝗕𝗢𝗠𝗕 𝗙𝗢𝗗 𝗗𝗨𝗡𝗚𝗔 𝗧𝗘𝗥𝗜 𝗠𝗔́𝗔̀ 𝗞𝗜 𝗝𝗛𝗔𝗔𝗧𝗘 𝗝𝗔𝗟 𝗞𝗘 𝗞𝗛𝗔𝗔𝗞 𝗛𝗢 𝗝𝗔𝗬𝗘𝗚𝗜💣",
    "SALEE TERE MA KO ROOJ CHUDU DUDH PIKE 🤣",
    "JUNGLE KO RAKH KAHTE H AAG  KO SAAS KAHTE H TERE MAA OR BHEN ROOJ KE VASHU KA LAND ISLIYE TERE KA KO HAM RANDIBASS KAHTE H 🥵🍌",
    "𝗗𝗨𝗗𝗛 𝗛𝗜𝗟𝗔𝗔𝗨𝗡𝗚𝗔 𝗧𝗘𝗥𝗜 𝗩𝗔𝗛𝗘𝗘𝗡 𝗞𝗘 𝗨𝗣𝗥 𝗡𝗜𝗖𝗛𝗘 🆙🆒😙",
    "𝘒𝘐 𝘊𝘏𝘖𝘒𝘏𝘈𝘛 𝘗𝘌 𝘉𝘌𝘛𝘏𝘈 𝘛𝘏𝘈 𝘈𝘠𝘐𝘐 𝘝𝘖 𝘓𝘈𝘕𝘋 𝘒𝘌 𝘊𝘏𝘈𝘓𝘐 𝘎𝘈𝘠𝘐 𝘗𝘛𝘈 𝘕𝘈𝘏𝘐 𝘒𝘈𝘉 𝘋𝘜𝘉𝘈𝘙𝘈 𝘈𝘠𝘌𝘎𝘐 𝘝𝘖 🍌",
    "BHEN KE LODE TERE BHEN KE DUDH KOO HILAKE CHODU ROOJ 12 BAJE 🍌🍌😍",
    "GALI GALI ME SHOOR TERE BHEN KI CHUT ME DALU APNA LAND FIR KARE VO SHOOR OR TERE BHEN EK NO KI RANDI CHOD🤣",
    "TERI MAA ROJ CHUDE OYO MAY BHEN KI LODI RANDI KI😋😛",
    "𝘒𝘐 𝘕𝘐𝘒𝘈𝘓 𝘎𝘈𝘠𝘐 𝘎𝘈𝘙𝘔𝘐𝘠𝘈 𝘈𝘕𝘌 𝘝𝘈𝘓𝘐 𝘏 𝘛𝘏𝘈𝘈𝘕𝘋 𝘉𝘏𝘌𝘕 𝘒𝘌 𝘓𝘖𝘋𝘌 𝘗𝘈𝘒𝘈𝘋 𝘓𝘌 𝘝𝘈𝘚𝘏𝘜 𝘒𝘈 𝘓𝘈𝘕𝘋",
    "𝗧𝗘𝗥𝗜 BHEN 𝗞𝗢 𝗛𝗢𝗥𝗟𝗜𝗖𝗞𝗦 𝗣𝗘𝗘𝗟𝗔𝗨𝗡𝗚𝗔 CHODU 𝗠𝗔̂𝗔̂𝗗𝗔𝗥𝗖𝗛Ø𝗗😚",
    "𝗧𝗘𝗥𝗜 𝗠𝗔́𝗔̀ 𝗞𝗜 𝗚𝗔𝗔𝗡𝗗 𝗠𝗘 𝗦𝗔𝗥𝗜𝗬𝗔 𝗗𝗔𝗔𝗟 𝗗𝗨𝗡𝗚𝗔 𝗠𝗔̂𝗔̂𝗗𝗔𝗥𝗖𝗛Ø𝗗 𝗨𝗦𝗜 𝗦𝗔𝗥𝗜𝗬𝗘 𝗣𝗥 𝗧𝗔𝗡𝗚 𝗞𝗘 𝗕𝗔𝗖𝗛𝗘 𝗣𝗔𝗜𝗗𝗔 𝗛𝗢𝗡𝗚𝗘 😱😱",
    "MADARCHOD KE PILLE BAAP HU FALTU NAHI MERE BETE NAHI TO CHOD DETA HU MAYG 🤩🤩",
    ...
    "TERI MAA MERE LODE PE OR TERE BHEN MERE JAAT KE BALO MAY MERE BETE BAAP SE PANGA NAHI TO GAND MARLUNGA BETE🤩🥳🔥😈",
    ...
    "𝗚𝗔𝗟𝗜 𝗚𝗔𝗟𝗜 𝗡𝗘 𝗦𝗛𝗢𝗥 𝗛𝗘 𝗧𝗘𝗥𝗜 𝗠𝗔́𝗔̀ 𝗥Æ𝗡𝗗𝗜 𝗖𝗛𝗢D 💋💋💦",
    ...
    "𝗧𝗘𝗥𝗜 𝗕𝗘́𝗛𝗘𝗡 𝗞𝗜 𝗖𝗛𝗨𝗨́𝗧𝗛 𝗠𝗘 𝗠𝗘𝗥𝗔 𝗟𝗨𝗡𝗗 D𝗔𝗔𝗟𝗔",
...
@app.on_message(
    filters.command("/vgali vashu gali de is bhen ke lode ko", prefixes=["/", "%" , "," , "@", "#"])
    & filters.private_and.groups
)
...
@app.on_message(
    filters.command("/vashu gali de is bhen ke lode ko", prefixes=["/", "%" , "," , "@", "#"])
    & filters.group
)
async def help(client: Client, message: Message):
    await message.reply_text(
        "**𝐓𝐡𝐢𝐬 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐈𝐬 𝐎𝐧𝐥𝐲 for gc /gali 𝐂𝐨𝐦𝐦𝐚𝐧𝐝.**"
    )
    @aap.on_message(
        filters.command("/gali mere admins and owner se request h ki gali command na likhe nahi to bot gali dega group pe ager gali deti h to lekhna vashu gali off kar" ,   prefixes=["/", "@","#"])
       & filters.group
...
@app.on_message(filters.command(["vgalioff", "vgalistop" , "vstop_gali"]))
    ...
    try:
        ...
        if participant.status in (
           # ChatMemberStatus.ADMINISTRATOR,
            ...
            is_admin = True
    if not is_admin:
        return await message.reply("𝐘𝐨𝐮 𝐀𝐫𝐞 𝐍𝐨𝐭 𝐀𝐝𝐦𝐢𝐧 𝐁𝐚𝐛𝐲, 𝐎𝐧𝐥𝐲 𝐀𝐝𝐦𝐢𝐧𝐬 OWNER 𝐂𝐚𝐧 STOP Gali command  .")
    else:
        try:
