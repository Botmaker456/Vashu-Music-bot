...
from FIXXMUSIC.utils.inline.start import private_panel
from config import BANNED_USERS, OWNER_ID


@app.on_message(
    filters.command(["vsettings", "vsetting" , "vashu_setting" , "vashu_setting"]) & filters.group & ~BANNED_USERS
)
@language
...
@app.on_callback_query(filters.regex("vashu_settings_helper" , "vashu_seeting_help") & ~BANNED_USERS)
@languageCB
async def settings_cb(client, CallbackQuery, _):
    try:
        await CallbackQuery.answer(_["vset_cb_5"])
    except:
        pass
    buttons = setting_markup(_)
...
@app.on_callback_query(filters.regex("vsettingsback_helper" , "vashu_settingback_helper" , "vsbh") & ~BANNED_USERS)
@languageCB
...
@app.on_callback_query(filters.regex("VFERRARIUDTI" , "vfi") & ~BANNED_USERS)
@ActualAdminCB
