...
bg_path = "FIXXMUSIC/assets/userinfo.png"
font_path = "FIXXMUSIC/assets/hiroko.ttf"
...
random_photo_links = [
    "https://telegra.ph/file/c15b57d9d9a9cf7a4a2d3.mp4",
    "https://telegra.ph/file/8b0666ba63bdc08bd8de7.mp4",
    "https://telegra.ph/file/e878048815ea43ac96a21.mp4",
                ...
                [
                    [
                        InlineKeyboardButton(
                            " ๏ 𝘈𝘋𝘋 𝘔𝘌 𝘉𝘈𝘉𝘠 𝘐𝘕 𝘠𝘖𝘜𝘙 𝘎𝘙𝘖𝘜𝘗 𝘖𝘙 𝘊𝘏𝘈𝘕𝘌𝘌𝘓 ๏ ", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")
                    ]
                ]
            ),
        )
        ...
        await client.send_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            " ๏ 𝘼𝘿𝘿 𝙈𝙀 𝘽𝘼𝘽𝙔 𝙄𝙉 𝙔𝙊𝙐𝙍 𝙂𝙍𝙊𝙐𝙋 𝙊𝙍 𝘾𝙃𝘼𝙉𝙀𝙀𝙇 ๏ ", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")
                    ]
                ]
            ),
        )
