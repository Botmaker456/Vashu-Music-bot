...
@app.on_message(filters.command("vunmuteall" ,"vashu unban all") & admin_filter)
async def vunmute_all(_, msg):
    chat_id = msg.chat.id
    ...
    if bot_permission:
        ...
        async for m in app.get_chat_members(chat_id, filter=enums.ChatMembersFilter.RESTRICTED):
            ...
            try:
                await app.restrict_chat_member(chat_id, banned_users[x],
