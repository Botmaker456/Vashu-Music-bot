...
from FIXXMUSIC.utils import AdminRightsCheck
from FIXXMUSIC.utils.database import is_active_chat, is_nonadmin_chat
from FIXXMUSIC.utils.decorators.language import languageCB
from FIXXMUSIC.utils.inline import close_markup, speed_markup
...
@app.on_message(
    filters.command(["cspeed", "speed", "cslow", "slow", "playback", "cplayback" , "vplay speed" , "vplayback" , "vlow"])
    & filters.group
    & ~BANNED_USERS
)
@AdminRightsCheck
