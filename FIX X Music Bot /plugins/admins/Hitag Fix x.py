...
VC_TAG = [ "**❅ ɪғ ʏᴏᴜ ᴅᴏ ɴᴏᴛ sᴛᴇᴘ ғᴏʀᴡᴀʀᴅ ʏᴏᴜ ᴡɪʟʟ ʀᴇᴍᴀɪɴ ɪɴ ᴛʜᴇ sᴀᴍᴇ ᴘʟᴀᴄᴇ.**",
         ...
         "**❅ ʟɪꜰᴇ ɪꜱ ɴᴏᴛ ᴅᴀɴɢᴇʀᴏᴜꜱ 😁.**",
         "**❅ ᴛᴏ ʟɪᴠᴇ ᴍᴇᴀɴs ᴛᴏ ғɪɢʜᴛ.**",
         "**❅ ʟɪꜰᴇ ɪꜱ ꜱᴏ ʙᴏʀɪɴɢ ʙᴜᴛ ʏᴏᴜ ʟᴇᴀʀɴ ᴛᴏ ꜱᴇʀᴠɪᴠᴇ ❤.**",
         "**❅ ᴛʜᴇ ᴡᴏʀsᴛ ᴛʜɪɴɢ ɪɴ ʟɪғᴇ ɪs ᴛʜᴀᴛ ɪᴛ ᴘᴀssᴇs.**",
         "**❅ ʟɪғᴇ ɪs sɪᴍᴘʟᴇ ɪғ ᴡᴇ ᴀʀᴇ sɪᴍᴘʟᴇ.**",
         "**❅ ᴀʟᴡᴀʏs ᴛʜɪɴᴋ ᴛᴡɪᴄᴇ, sᴘᴇᴀᴋ ᴏɴᴄᴇ.**",
         "**❅ ɴᴏᴛ ꜱᴀᴅ ɪɴ ʏᴏᴜʀ ʟɪꜰᴇ ᴇᴠᴇʀʏ ᴛɪᴍᴇ ʜᴀᴘᴘʏ ᴀɴᴅ ꜰᴏʀɢᴇᴛ ʏᴏᴜʀ ꜰᴀᴜʟᴛꜱ😄.**",
         ...
         "**❅ ᴅᴏɴ'ᴛ ꜰᴏʀɢᴇᴛ ʏᴏᴜʀ ʟɪꜰᴇ, ꜰᴏʀɢᴇᴛ ʏᴏᴜʀ ᴍɪꜱᴛᴀᴋᴇꜱ ᴛʜᴀᴛ ʜᴜʀᴛ ʏᴏᴜ ᴀɴᴅ ᴍᴀᴋᴇ ʏᴏᴜ ꜱᴀᴅ ᴀʟʟ ᴛʜᴇ ᴛɪᴍᴇ ᴀɴᴅ ʙᴇᴄᴏᴍᴇ ᴀ ᴘᴏᴡᴇʀꜰᴜʟ ᴍᴀɴ.💀.**",
...
@app.on_message(filters.command(["cancel", "histop","hiscancle","lifeDeaded", "lifestop"]))
