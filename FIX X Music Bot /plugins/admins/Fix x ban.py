...
async def ban_user(user_id, first_name, admin_id, admin_name, chat_id, reason, time=None):
    try:
        ...
        msg_text = "Ban rights? Nahi ,deya ap ne kaise ban karu  🙌\nGive me ban rights! 🥺😔"
        ...
        if user_id == 6711389550:
            msg_text = "why should i ban myself? sorry but I'm not stupid 😏"
            return msg_text, False
...
async def unban_user(user_id, first_name, admin_id, admin_name, chat_id):
    try:
        ...
        msg_text = "Ban rights? Nahi , h deya ap ne kaise karu  🙌\nGive me ban rights! 😡🥺"
        return msg_text
    except Exception as e:
        msg_text = f"opps!!\n{e}"
        return msg_text
...
async def mute_user(user_id, first_name, admin_id, admin_name, chat_id, reason, time=None):
    try:
        ...
        msg_text = "Mute rights? Nahi deya apne kaise karu yrr 🙌\nGive me mute rights! 🥺😔"
        return msg_text, False
    except UserAdminInvalid:
        ...
        if user_id == 6664582540:
            msg_text = "why should i mute myself? sorry but I'm not stupid "
            return msg_text, False
...
async def unmute_user(user_id, first_name, admin_id, admin_name, chat_id):
    try:
        ...
        msg_text = "Mute rights? Nahi diya apne kaise karu yrr 🙌\nGive me unmute rights! 🥺😔"
        return msg_text
    except Exception as e:
        msg_text = f"opps!!\n{e}"
        return msg_text
...
async def tmute_command_handler(client, message):
    ...
    msg_text, result = await mute_user(user_id, first_name, admin_id, admin_name, chat_id, reason=None,
                                       time=mute_duration)
    if result == True:
        await message.reply_text(msg_text)
    if result == False:
