...
@app.on_message(filters.command("purge" , "vashu purge") & admin_filter)
async def purge(app: app, msg: Message):
    ...
    async def vashu_purge(app: app, msg: Message):
        if msg.chat.type != ChatType.SUPERGROUP:
            await msg.reply_text(text="** ꜱᴏʀʀʏ ᴊɪ ᴍᴀʏ ᴍᴇꜱꜱᴀɢᴇ ᴘᴜʀɢᴇ ɴᴀʜɪ ᴋᴀʀ ꜱᴀᴋᴛɪ ᴋʏᴏ ᴋɪ ᴀᴘ ᴋᴀ ʙᴀꜱɪᴄ ɢʀᴏᴜᴘ ʜ ᴀᴜʀ ʏᴇ ᴄᴏᴍᴍᴀɴᴅ ꜱᴜᴘᴇʀ ɢʀᴏᴜᴘ ᴍᴇ ᴄʜᴀʟᴛɪ ʜ.**")
            return
