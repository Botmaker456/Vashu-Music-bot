...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await FIXX.pause_stream(chat_id)
        ...
        if command == "Skip":
            txt = f"➻ sᴛʀᴇᴀᴍ sᴋɪᴩᴩᴇᴅ /ᴀʀᴇᴇ ᴀᴘ ɴᴇ ꜱᴛʀᴇᴀᴍ ꜱᴋɪᴘ ᴋᴀʀᴅᴇ 🥺\n│ \n└ʙʏ : {mention} 🥀"
            popped = None
            try:
                popped = check.pop(0)
                if popped:
                ...
                if not check:
                    await CallbackQuery.edit_message_text(
                        f"➻ sᴛʀᴇᴀᴍ sᴋɪᴩᴩᴇᴅ/ᴀʀᴇᴇ ᴀᴘ ɴᴇ ꜱᴛʀᴇᴀᴍ ꜱᴋɪᴘ ᴋᴀʀᴅᴇ🥺\n│ \n└ʙʏ : {mention} 🥀"
                    )
                    await CallbackQuery.message.reply_text(
            ...
            txt = f"➻ sᴛʀᴇᴀᴍ ʀᴇ-ᴘʟᴀʏᴇᴅ/ᴛʜᴀɴᴋꜱ ᴅᴜʙᴀʀᴀ ꜱᴛʀᴇᴀᴍ ᴄʜᴀʟᴜ ᴋᴀʀɴᴇ ᴋᴇ ʟɪʏᴇ💕\n│ \n└ʙʏ : {mention} 🥀"
        await CallbackQuery.answer()
        queued = check[0]["file"]
