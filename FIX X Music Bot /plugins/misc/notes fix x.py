...
from FIXXMUSIC.mongo.notesdb import *
from FIXXMUSIC.utils.notes_func import GetNoteMessage, exceNoteMessageSender, privateNote_and_admin_checker
from FIXXMUSIC.utils.yumidb import user_admin
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup, Message, CallbackQuery
from pyrogram.enums import ChatMemberStatus


@app.on_message(filters.command("vsave" , "vashusave") & admin_filter)
@user_admin
...
@app.on_message(filters.command("vget" ,"vgt" ,"vashuget") & admin_filter)
...
@app.on_message(filters.command("vprivatenotes") & filters.group)
@user_admin
...
@app.on_message(filters.command("vashuclear" , "/vashuclear") & admin_filter)
@user_admin
...
@app.on_message(filters.command("vclearall") & admin_filter)
...
@app.on_callback_query(filters.regex("^vclearallnotes_"))
...
@app.on_message(filters.command(['vnotes', 'vsaved']) & filters.group)
