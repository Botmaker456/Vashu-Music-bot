...
@DAXX.on_message(filters.command("vmongochk" , "vashu_mongochk"))
async def mongo_command(client, message: Message):
    ...
    if re.match(mongo_url_pattern, mongo_url):
        ...
        await message.reply("𝗜𝗻𝘃𝗮𝗹𝗶𝗱 𝗠𝗼𝗻𝗴𝗼𝗗𝗕 𝗨𝗥𝗟 𝗳𝗼𝗿𝗺𝗮𝘁/𝘼𝙍𝙀𝙀 𝙔𝙀 𝘼𝙋 𝙆𝙔𝘼 𝙆𝘼𝙍 𝙍𝘼𝘼𝙃𝙀 𝙃𝙊 𝙅𝙄 𝙎𝘼𝙃𝙄 𝙎𝙀 𝙆𝘼𝙍𝙊 𝙉𝘼𝙃𝙄 𝘼𝙔𝙀𝙂𝘼 𝙄𝙉𝙑𝘼𝙇𝙄𝘿💔")