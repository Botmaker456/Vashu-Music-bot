...
async def kang(client, message: Message):
    if not message.reply_to_message:
        return await message.reply_text("Reply to a sticker/image to kang/create it.")
    ...
    try:
        if message.reply_to_message.sticker:
            ...
            return await msg.edit("Nope, can't create/kang that.")
        ...
        while True:
            ...
            if not stickerset:
                stickerset = await create_sticker_set(
                    ...
                    f"{message.from_user.first_name[:32]}'s kang/stiker pack",
                    packname,
                    [sticker],
                )
