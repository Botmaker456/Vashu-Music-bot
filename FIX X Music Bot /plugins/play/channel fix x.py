...
from FIXXMUSIC.utils.database import set_cmode
from FIXXMUSIC.utils.decorators.admins import AdminActual
from config import BANNED_USERS


@app.on_message(filters.command(["vchannelplay"]) & filters.group & ~BANNED_USERS)
@AdminActual
