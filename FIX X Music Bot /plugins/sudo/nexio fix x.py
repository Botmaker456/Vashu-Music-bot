...
Yumikoo_text = [
    ...
    "leave me alone",
    "dude what happend",
    " aur batao kaise ho ji ",
    "apka name kya h ji ".
    "khana khalia apne ji ",
    "chalo aaj shopping karne chalte h
    "vashu acha or cute ladka h ",
]
...
ban = ["vban", "vboom"]
unban = ["vunban", ]
mute = ["vmute", "silent", "shut"]
unmute = ["unmute", "speak", "free"]
kick = ["vkick", "out", "nikaal", "nikal"]
promote = ["vpromote", "vadminship"]
fullpromote = ["vfullpromote", "vfulladmin"]
demote = ["vdemote", "lelo"]
group = ["vgroup"]
channel = ["vchannel"]
...
@app.on_message(filters.command(["ug", "uggy"], prefixes=["b", "B"]) & admin_filter)
        ...
        for banned in data:
            ...
            if banned in ban:
                if user_id in SUDOERS:
                    ...
                    await message.reply("OK, Ban kar diya madrchod ko salee  jake maa chuday randi ka  !")
        ...
        for kicked in data:
            ...
            if kicked in kick:
                if user_id in SUDOERS:
                    ...
                    await app.ban_chat_member(chat_id, user_id)
                    await app.unban_chat_member(chat_id, user_id)
                    await message.reply("get lost! bhga diya bhosdi wale ko sala kaisa tha habssi jaisa")
