...
from FIXXMUSIC.utils.database import autoend_off, autoend_on


@app.on_message(filters.command("vautoend" , "vashuautoend") & SUDOERS)
async def vauto_end_stream(_, message: Message):
